...
The daemon has the default OpeNER daemon options. Being:
    ...
    -h, --help                Shows this help message
    -i, --input               The name of the input queue (default: opener-kaf-naf-parser)
    -b, --bucket              The S3 bucket to store output in (default: opener-kaf-naf-parser)
    -P, --pidfile             Path to the PID file (default: /var/run/opener/opener-kaf-naf-parser-daemon.pid)
